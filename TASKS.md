...
| F-0.2 (parcial) | Catálogo de rutas, checks de CI y contratos base | Implementada | `2cc6f5b`, `16dd55d`. 544 rutas inventariadas con su mecanismo de autorización; 0 sin proteger tras corregir `PUT /sesion/departamento`. Encoding, sincronía de versiones y autorización de rutas pasan a validarse en CI. Falta el inventario de bindings y migraciones, y la auditoría remota de Cloudflare. |
