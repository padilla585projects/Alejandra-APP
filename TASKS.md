...
- Siguiente acción exacta: abrir el PR de la rama `feat/arc011-lote3-retirar-ddl-runtime`, fusionar con CI verde, y cuando el Director abra la ventana de despliegue, desplegar `worker.js` una sola vez para verificar los 6 verticales agrupados (paso 4).
