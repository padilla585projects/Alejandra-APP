...
**Sesion:** LIBRE
**Fecha:** 25/07/2026 -- ORG-03/ORG-04/ROLES-04 completados v8.21: menú de Office propio para Mecánicas y Seguridad (Técnico/Recursos Preventivos), rol Ingeniero dado de alta, y catálogo de roles completado en 6 sitios donde faltaban project_manager/almacenero/ingeniero (incluido un desplegable de departamento desactualizado desde INGENIERIA-01 que aún ofrecía "Oficina técnica").
**Versión actual:** v8.21 (version.json/sw.js/index.html sincronizados)
**Resumen:** Continuación de la sesión de Part 48 (roles). Adrián: "ahora tenemos que arreglar los demás departamentos con sus roles que estén bien como hemos echo con Electricas". Confirmado por AskUserQuestion: menú propio por departamento (no genérico por rol), empezando por Mecánicas (Part 50) y siguiendo por Seguridad (Part 51). En el camino, Adrián explicó cómo funciona la empresa: cada departamento tiene los mismos roles que Eléctrico (Encargado/Operario), por encima de los departamentos están Project Manager/Admin/Desarrollador, Ingeniería solo tenía un rol futuro "Ingeniero" (no existía todavía en el sistema), y en Seguridad Encargado se llama "Técnico" y Operario "Recursos Preventivos" (ej. Katherine) — mismo rol interno, solo cambia el nombre visible. Ver Parts 50-52.
