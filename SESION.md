...
**PARA RETOMAR EN OTRO CHAT:** sesión cerrada limpia, sin trabajo a medias (todo commiteado, pusheado y desplegado; npm test 85/85 verde en cada paso). Sin pendientes de esta sesión salvo los ya anotados de sesiones anteriores (`AGENTS.md`, `_fix_ia_acceso.js`).
