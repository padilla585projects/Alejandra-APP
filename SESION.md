...
- **Resend sigue en dominio sandbox** (`noreply@resend.dev`) — requiere verificar un dominio propio en el panel de Resend, acción externa de Adrián.
...
- **"Quiero quitar columnas del inventario que no valen y añadir otras"** (Part 58): pedido por Adrián, nunca llegó a especificar cuáles. Preguntar antes de tocar la tabla de Bobinas otra vez.
