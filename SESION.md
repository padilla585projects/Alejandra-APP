...
**Sesion:** EN CURSO
**Fecha:** 22/07/2026 -- ORG-01: sidebar de panel.html organizado de verdad por rol/departamento (no solo admin/no-admin) + filtrado real por departamento en planos y fotos de obra
...
- (pendiente de hash) — feat: sidebar de panel.html organizado por rol/departamento (encargado/operario ven menos ítems de PM) + filtrado real por departamento en planos y fotos de obra (ORG-01)
