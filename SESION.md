...
**PARA RETOMAR EN OTRO CHAT:** sesión cerrada limpia, sin trabajo a medias (todo commiteado, pusheado y desplegado; npm test 85/85 verde en cada paso). Pendiente explícito para otra sesión:
- **Verificar Grok en vivo** — forzar (con cuidado, en un momento controlado) un fallo real o simulado de Anthropic para confirmar que `_intentarGrokFallback` responde bien de extremo a extremo; hasta ahora solo verificado por código/tests, no ejercitado en producción.
