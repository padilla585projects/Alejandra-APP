...
| ARC-002 | Pendiente | Gobierno de memoria | Alto | Definir privacidad, tenant, procedencia, confianza, caducidad, corrección y borrado. Requiere ADR y compliance. **Bloquea explícitamente** que `nucleo-cognitivo/` (F-1.2, iniciado el 2026-08-02) active memoria persistente: el componente Memory se queda fuera del esqueleto hasta resolver esto. |
